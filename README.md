...
Public container image is [available on GitHub Container Registry](https://github.com/users/SUYAMBULAKSHMI-VENKATESAN/packages/container/package/python-demoapp)
